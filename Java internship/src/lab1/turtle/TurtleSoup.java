...
public class TurtleSoup {
    ...
    public static int calculatePolygonSidesFromAngle(double angle) {
        //throw new RuntimeException("implement me!");
        return Integer.parseInt(new java.text.DecimalFormat("0").format(360/(180-angle)));
    }
    ...
    public static double calculateBearingToPoint(double currentBearing, int currentX, int currentY,
        ...
        //double tmp=Math.atan((targetX-currentX)/(targetY-currentY));
    	if (targetX<currentX) {
			tmp+=360;
		}
    ...
    public static List<Double> calculateBearings(List<Integer> xCoords, List<Integer> yCoords) {
    	...
    	for(int i=0;i<xCoords.size()-1;++i) {
    		x1=xCoords.get(i).intValue();
    		y1=yCoords.get(i).intValue();
    		x2=xCoords.get(i+1).intValue();
    		y2=yCoords.get(i+1).intValue();
    		tmp=calculateBearingToPoint(angle, x1, y1, x2, y2);
